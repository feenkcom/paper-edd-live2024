...
\todo{refer to Bush's memex vision from the 40s? -- Bush, Vannevar, "As We May Think," The Atlantic Monthly (July 1945). Mentions idea of trails of documents.}
\todo{cite Engelbart https://dougengelbart.org/content/view/138/000/ refers to linki ng and association}

\todo{
Notebook systems such as Jupyter (REF), MATLAB Live Scripts (REF) and Wolfram Notebooks (REF) all offer the ability to embed live instances of classes within notebook pages, but these live examples are neither integrated with unit testing frameworks, not do they support custom tooling with the help of moldable tools to tailor the user experience.
}
...
\todo{Somewhere refer to MD patterns \cite{Nier24a} and moldable excptions \cite{Chis24a}}
